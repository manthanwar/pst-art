...
An LED $5 \times 7$ dot matrix is a rectangular grid of 35 light-emitting diodes arranged in 5 columns and 7 rows. It acts as a single, highly customizable display module used to show alphanumeric characters, simple graphics, or symbols in electronic projects. Because they are bright, compact, and affordable, they are widely used in hobbyist DIY builds and industrial panels as information boards or displays.
...
\begin{verbatim}\psset{unit=1mm,fillstyle=solid,linestyle=none,dimen=middle}
\psset{ledColorOn=yellow,ledWidth=8,ledDistance=0}
\rput(10mm,-8mm){\psLedDisplay{Volt ~ : ~ 0123 V}}
