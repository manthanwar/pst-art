...
%---------------+---------+----------------------------------------------------
% 26-Jul-2026   | AMM     | fixed the order of loading packages /issues/2
%---------------+---------+----------------------------------------------------
%---------------+---------+----------------------------------------------------
%---------------+---------+----------------------------------------------------
%===============================================================================
...
\paragraph{Usage:}
Load the package \texttt{pst-flags} via the \verb|\usepackage| macro. 
Now you are ready to use the \texttt{pst-flags} macros within your document body. This macro is described in the next section with all its options. With the help of the following simple \LaTeX-source code, you can test whether you have correctly installed the package:
